...
export const Header = () => {
  return (
    <header className="fixed left-0 top-0 z-50 w-full bg-gradient-to-r from-background/70 via-background/50 via-50% to-background/75 to-90% bg-clip-border text-foreground/75 backdrop-blur-[2px] backdrop-filter">
